...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-950 relative pt-24">
        {/* Fixed background */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-12">
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
              ...
              {selectedLocation && (
                <div className="flex items-center gap-3 px-6 py-4 bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl">
                  <div className="w-3 h-3 bg-climate-500 rounded-full animate-pulse"></div>
                  <div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 lg:p-8">
              <LocationSearch 
            ...
            {loading ? (
              ...
              <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-12">
                <div className="text-center">
                  <div className="w-20 h-20 bg-warning-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-10 h-10 text-warning-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <ul className="text-sm text-gray-500 space-y-2 mb-6 text-left max-w-md mx-auto">
                  ...
                  <button 
                    ...
                    className="px-6 py-3 bg-climate-500 hover:bg-climate-600 text-white rounded-xl font-semibold transition-colors"
                  >
                    Retry Loading Data
                  </button>
                </div>
