          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <div className="h-full p-6 sm:p-8 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-gray-700 transition-all duration-300">
                  {/* Icon */}
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-climate-500/10 border border-climate-500/20 flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-climate-500/20 transition-colors">
                    <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-climate-400" />
                  </div>
